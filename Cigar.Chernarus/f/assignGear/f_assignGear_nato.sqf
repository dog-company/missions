...
_smg = "CUP_arifle_G36C";
_smgmag = "CUP_30Rnd_556x45_G36";
_smgmag_tr = "CUP_30Rnd_556x45_G36";
...
// Crewman
_crewUniform = ["TRYK_U_B_OD_OD_CombatUniform", "TRYK_U_B_OD_OD_R_CombatUniform"];
_crewHelmet = ["TRYK_H_PASGT_BLK"];
