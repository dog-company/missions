...
_silencer1 = "muzzle_snds_H";	// 5.56 suppressor
...
_carbine = "CUP_sgun_M1014";
_carbinemag = "CUP_8Rnd_B_Beneli_74Slug";
_carbinemag_tr = "CUP_8Rnd_B_Beneli_74Pellets";

// Standard Submachine Gun/Personal Defence Weapon (Aircraft Pilot, Submachinegunner)
_smg = "CUP_sgun_M1014";
_smgmag = "CUP_8Rnd_B_Beneli_74Slug";
_smgmag_tr = "CUP_8Rnd_B_Beneli_74Pellets";
...
_glrifle = "CUP_arifle_M4A1_BUIS_camo_GL";
...
// Woodland-Hex
_baseUniform = ["TRYK_U_B_PCUs"];
_baseHelmet = ["TRYK_H_GR"];
_baseGlasses = [];
...
// Vests
_lightRig = ["TRYK_V_ArmorVest_AOR2_2"];
_mediumRig = ["TRYK_V_ArmorVest_AOR2_2"]; 	// default for all infantry classes
