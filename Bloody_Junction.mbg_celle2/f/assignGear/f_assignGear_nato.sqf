...
_baseUniform = ["TRYK_U_B_OD_OD_CombatUniform", "TRYK_U_B_OD_OD_R_CombatUniform"];
...
// Ghillie
_ghillieUniform = ["TRYK_U_B_OD_OD_CombatUniform", "TRYK_U_B_OD_OD_R_CombatUniform"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = [];
_ghillieRig = ["V_PlateCarrier1_blk", "V_PlateCarrier2_blk"];
_ghillieGlasses = [];
