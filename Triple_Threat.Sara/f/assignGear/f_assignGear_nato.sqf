...
// Default setup
_attachments = [_attach1, _scope1, _bipod2]; // The default attachment set for most units, overwritten in the individual unitType
...
_carbine = "hlc_smg_mp5a4";
_carbinemag = "hlc_30Rnd_9x19_B_MP5";
_carbinemag_tr = "hlc_30Rnd_9x19_B_MP5";
...
_glriflemag_tr = "hlc_30Rnd_556x45_B_AUG";
...
_baseUniform = ["TRYK_U_B_BLKBLK_R_CombatUniform", "TRYK_U_B_BLKBLK_CombatUniform"];
...
// Crewman
_crewUniform = ["V_PlateCarrier1_blk"];
