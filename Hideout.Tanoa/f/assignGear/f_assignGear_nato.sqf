...
_scope1 = "CUP_optic_CompM2_Desert";	// Holosight
...
// [] = remove all
// [_attach1,_scope2,_silencer] = remove all, add items assigned in _attach1, _scope1 and _silencer1
...
_smg = "CUP_arifle_Mk16_CQC_FG";
_smgmag = "CUP_30Rnd_556x45_Stanag";
_smgmag_tr = "CUP_30Rnd_556x45_Stanag";
...
_nvg = "TRYK_US_ESS_Glasses_TAN_BLK";
...
_bagmediumdiver =  "B_Kitbag_cbr";		// used by divers
...
// Automatic Rifleman
_AR = "CUP_sgun_M1014";
_ARmag = "CUP_8Rnd_B_Beneli_74Slug";
_ARmag_tr = "CUP_8Rnd_B_Beneli_74Pellets";

// Medium MG
// _MMG = "rhs_weap_m240B";
// _MMGmag = "rhsusf_100Rnd_762x51";
// _MMGmag_tr = "rhsusf_100Rnd_762x51_m993";
...
_baseUniform = ["TRYK_U_B_BLKTAN_CombatUniform", "TRYK_U_B_TANTAN_R_CombatUniform", "TRYK_U_B_BLKTANR_CombatUniformTshirt"];
_baseHelmet = ["TRYK_H_PASGT_TAN"];
_baseGlasses = [];

// Vests
_lightRig = ["V_PlateCarrier1_blk", "V_PlateCarrier2_blk"];
_mediumRig = ["V_PlateCarrier1_blk", "V_PlateCarrier2_blk"]; 	// default for all infantry classes
_heavyRig = ["V_PlateCarrier1_blk", "V_PlateCarrier2_blk"];
...
// Crewman
_crewUniform = ["TRYK_U_B_BLKTAN_CombatUniform", "TRYK_U_B_TANTAN_R_CombatUniform", "TRYK_U_B_BLKTANR_CombatUniformTshirt"];
_crewHelmet = ["TRYK_H_PASGT_TAN"];
_crewRig = ["V_PlateCarrier1_blk", "V_PlateCarrier2_blk"];
_crewGlasses = [];
...
// CARGO: TRUCK - room for 50 weapons and 200 cargo items
	case "v_tr":
	{
		...
		_unit addBackpackCargoGlobal [_bagsmall, 5];
	};
