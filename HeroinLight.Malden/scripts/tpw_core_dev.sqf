...
tpw_mods_version = "20151021"; // will appear on start hint
...
// CONVERT UNIT'S STAMINA (60-0) TO FATIQUE (0-1)
tpw_core_fnc_s2f =
	{
	private ["_unit","_ft"];
	_unit = _this select 0;
	_ft = 1 - (getstamina _unit) / (60 * (1 - load _unit)); // thanks to Ceeeb for this equation
		_ft
	};
