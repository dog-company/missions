...
Comment "Uniform";
_unit forceAddUniform "TRYK_U_B_TANTAN_CombatUniform";
...
Comment "Backpack";
_unit addBackpack "milgp_bp_marciras_Pointman_mc";
...
Comment "Helmet";
_unit addHeadgear "milgp_h_airframe_Combat_khk";

Comment "Weapon";
_unit addWeapon "SMA_M4afg_Tan";
