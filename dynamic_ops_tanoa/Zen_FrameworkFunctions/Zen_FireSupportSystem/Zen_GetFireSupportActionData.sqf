...
_Zen_stack_Trace = ["Zen_GetFireSupportActionData", _this] call Zen_StackAdd;
...
if (count _templateArray == 0) then {
    0 = ["Zen_GetFireSupportActionData", "Given action identifier does not exist.", _this] call Zen_PrintError;
    call Zen_StackPrint;
};
