...
_Zen_stack_Trace = ["Zen_FindMinDistance", _this] call Zen_StackAdd;
...
if (count _testArray > 0) then {
    ...
    0 = ["Zen_FindMinDistance", "Given array to compare to the center is empty", _this] call Zen_PrintError;
    call Zen_StackPrint;
};
