...
_Zen_stack_Trace = ["Zen_AreInArea", _this] call Zen_StackAdd;
private ["_unitsArray", "_polygonArgs", "_areInArea", "_unit", "_isInArea", "_isInBlacklist", "_blacklist", "_inAreaArgs"];
