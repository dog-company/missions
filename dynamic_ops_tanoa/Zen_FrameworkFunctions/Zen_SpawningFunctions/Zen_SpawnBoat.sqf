...
private ["_spawnPos", "_sideOrClass", "_vehClass", "_dir", "_faction", "_veh", "_DLC"];
...
if (typeName _sideOrClass != "SIDE") then {
    ...
    switch (_sideOrClass) do {
        case west: {
            _vehClass = [(["ship", _sideOrClass, "All", _faction, "All", "Both", _DLC] call Zen_ConfigGetVehicleClasses)] call Zen_ArrayGetRandom;
        };
        case east: {
            _vehClass = [(["ship", _sideOrClass, "All", _faction, "All", "Both", _DLC] call Zen_ConfigGetVehicleClasses)] call Zen_ArrayGetRandom;
        };
