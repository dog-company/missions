...
// CARGO: CAR - room for 10 weapons and 50 cargo items
	case "v_car":
	{
		...
		_unit addMagazineCargoGlobal [_shotgunmag, 10];
...
// CARGO: TRUCK - room for 50 weapons and 200 cargo items
	case "v_tr":
	{
		...
		_unit addMagazineCargoGlobal [_shotgunmag, 40];
...
// CARGO: IFV - room for 10 weapons and 100 cargo items
	case "v_ifv":
	{
		...
		_unit addMagazineCargoGlobal [_shotgunmag, 20];
	...
	case "crate_small":
{
		...
		_unit addMagazineCargoGlobal [_armag, 5];
		_unit addMagazineCargoGlobal [_shotgunmag, 5];
	...
	case "crate_large":
{
		...
		_unit addMagazineCargoGlobal [_smgmag, 60];
		_unit addMagazineCargoGlobal [_armag, 45];
		_unit addMagazineCargoGlobal [_shotgunmag, 60];
