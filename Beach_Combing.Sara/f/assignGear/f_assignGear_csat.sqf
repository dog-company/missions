...
_silencer1 = "rhs_acc_dtk";	// 5.56 suppressor
_silencer2 = "muzzle_snds_H";	// 6.5 suppressor

_scope1 = "rhs_acc_1p63";		// ACO
...
_baglarge =  "B_TacticalPack_ocamo"; 			// carries 320, weighs 40
...
// Woodland-Hex
_baseUniform = ["rhs_uniform_vdv_emr", "rhs_uniform_vdv_mflora"];
_baseHelmet = ["rhs_6b27m_ml_ess", "rhs_6b27m_ml"];
_baseGlasses = [];
